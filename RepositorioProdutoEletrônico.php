...
class RepositorioProdutoEletronico{
    ...
    public function cadastrar(ProdutoEletronico $prudutoeletronico, PDO $pdo){
        ...
        $marca = $pessoa->exibirmarca();
        $modelo = $pessoa->exibirmodelo();
        $funcoes = $pessoa->exibirfuncoes();
        $preco = $pessoa->exibirpreco();
        $tamanho = $pessoa->exibirtamanho();
